...
import 'package:for_beginners_531/screens/weights/week1/press_table.dart';

class Week1PressTableScreen extends StatelessWidget {
  final AuthService _auth = AuthService();

  Week1PressTableScreen({this.uid});
