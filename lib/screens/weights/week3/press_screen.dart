...
import 'package:for_beginners_531/screens/weights/week3/press_table.dart';

class Week3PressTableScreen extends StatelessWidget {
  final AuthService _auth = AuthService();

  Week3PressTableScreen({this.uid});
