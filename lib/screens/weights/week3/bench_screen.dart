...
import 'package:for_beginners_531/screens/weights/week3/bench_table.dart';

class Week3BenchTableScreen extends StatelessWidget {
  final AuthService _auth = AuthService();

  Week3BenchTableScreen({this.uid});
