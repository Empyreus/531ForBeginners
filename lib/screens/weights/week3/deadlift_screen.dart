...
import 'package:for_beginners_531/screens/weights/week3/deadlift_table.dart';

class Week3DeadliftTableScreen extends StatelessWidget {
  final AuthService _auth = AuthService();

  Week3DeadliftTableScreen({this.uid});
