...
import 'package:for_beginners_531/screens/weights/week2/squat_table.dart';

class Week2SquatTableScreen extends StatelessWidget {
  final AuthService _auth = AuthService();

  Week2SquatTableScreen({this.uid});
