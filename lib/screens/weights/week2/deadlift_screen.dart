...
import 'package:for_beginners_531/screens/weights/week2/deadlift_table.dart';

class Week2DeadliftTableScreen extends StatelessWidget {
  final AuthService _auth = AuthService();

  Week2DeadliftTableScreen({this.uid});
  final String uid;
